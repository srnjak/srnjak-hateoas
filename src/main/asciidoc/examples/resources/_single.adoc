...
----
include::{examples}/resources/TestResource.java[tags=single,indent=0]
----
...
[subs="verbatim,attributes"]
----
include::{snippets}/output/json/single.json[]
----
...
[subs="verbatim,attributes"]
----
include::{snippets}/output/xml/single.xml[]
----
...
[subs="verbatim,attributes"]
----
include::{snippets}/output/hal-json/single.json[]
----
...
[subs="verbatim,attributes"]
----
include::{snippets}/output/hal-xml/single.xml[]
----